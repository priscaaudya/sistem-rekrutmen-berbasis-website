...
<div class="row">
    ...
    <div class="col-lg-4 py-2">
      <div class="card-blog">
        ...
        <div class="body">
          <h5 class="post-title"><a href="/dashboard/{{ $job->slug }}">{{ $job->position }}</a></h5>
        ...
        <div class="col-3">
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <p><i class="fa fa-clock"></i> {{  Carbon\Carbon::parse($job->close_date)->isoFormat('dddd, D MMMM Y') }}</p>
                    <div class="text-center mt-4">
                        <a href="/dashboard/{{ $job->slug }}" class="btn btn-primary btn-lg border-0 btn-rounded px-5">Lihat</a>
                    </div>
                </div>
            </div>
        </div>
