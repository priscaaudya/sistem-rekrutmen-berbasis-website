            ...
            <table class="table table-striped table-bordered zero-configuration" style="border: 1">
                ...
                <tbody>
                    ...
                    <tr align="center">
                        ...
                        <td>
                            <a href="/inactivevacancies/{{ $job->slug }}" class="btn btn-info" data-toggle="modal" data-target="#modalshow{{$job->slug}}"><i class="fas fa-eye"></i></a>
                            <a href="/inactivevacancies/{{ $job->slug }}/edit" class="btn btn-warning" data-toggle="modal" data-target="#modaledit{{$job->slug}}"><i class="fas fa-edit"></i></a>
                            <a href="/inactivevacancies/{{ $job->slug }}" class="btn btn-danger" data-toggle="modal" data-target="#modaldelete{{$job->slug}}"><i class="fas fa-trash-alt"></i></a>
                        </td>
                    </tr>
