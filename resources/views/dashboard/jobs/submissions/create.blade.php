        ...
        <form action="/submissions" method="post" class="d-inline">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <textarea class="form-control @error('requirement') is-invalid @enderror" name="requirement" id="requirement" cols="106" rows="8">{{ old('requirement')}}</textarea>
                </div>
                <div class="modal-body">
                    ...
                    @error('attachment')
                        <p class="text-danger"> {{ $message }} </p>
                    @enderror
                    <textarea class="form-control @error('attachment') is-invalid @enderror" name="attachment" id="attachment" cols="106" rows="5">{{ old('attachment')}}</textarea>
                </div>
                <div class="modal-body">
                    <label for="close_date" class="form-label">Tanggal Tutup</label>
                    <input type="date" class="form-control @error('close_date') is-invalid @enderror" id="close_date" name="close_date" required value="{{ old('close_date') }}">
                    @error('close_date')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="modal-body">
                    ...
                    <input type="date" class="form-control @error('announ_date') is-invalid @enderror" id="announ_date" name="announ_date" required value="{{ old('announ_date') }}">
                    @error('announ_date')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
