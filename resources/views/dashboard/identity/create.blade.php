...
<head>
    ...
    <link href="/dashboard1/icons/material-design-iconic-font/materialdesignicons.min.css" rel="stylesheet" type="text/css">
        ...
        ***********************************-->
        <div class="nav-header" style="background-color: white">
            <div class="brand-logo">
                <a href="/">
                    <b class="logo-abbr"><img src="/img/logofix.png" alt=""> </b>
                    <span class="logo-compact"><img src="/img/logo3.png" alt="" style="width: 100%"></span>
                    <span class="brand-title">
                        <img src="/img/logo3.png" alt="" style="width: 100%">
                    </span>
                </a>
            </div>
        </div>
                    ...
                    <div class="drop-down dropdown-profile animated fadeIn dropdown-menu">
                        <div class="dropdown-content-body">
                            <ul>
                                ...
                                @can('applicant')
                                <li>
                                    <a href="{{ route('profile.edit') }}"><i class="fa fa-user"></i><span> Profil</span></a>
                                </li>                                        
                                @endcan
                                <li>
                                    <a href="{{ route('password.edit') }}"><i class="fa fa-gear"></i><span> Ubah Password</span></a>
                                </li>                                        
                                <hr class="my-2">
                                {{-- <li> --}}
