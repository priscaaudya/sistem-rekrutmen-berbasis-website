...
<div class="form-validation justify-content-center d-flex">
    <form class="form-valide" action="{{ route('password.update') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <input type="password" name="current_password" class="form-control @error('current_password') is-invalid @enderror" id="current_password" placeholder="password" required>
        ...
        <div class="form-group">
            <input type="password" name="password" class="form-control @error('password') is-invalid @enderror" id="password-field" placeholder="password baru" required>
