                ...
                <table class="table table-striped table-bordered zero-configuration" style="border: 1">
                    ...
                    <tbody>
                        ...
                        <tr align="center">
                            ...
                            <td>
                                <a href="/scheduleapproval/{{ $schedule->id }}/add" class="btn btn-warning" data-toggle="modal" data-target="#modalcreate{{$schedule->id}}"><i class="fas fa-plus"></i></a>
                                <a href="/scheduleapproval/{{ $schedule->id }}" class="btn btn-danger" data-toggle="modal" data-target="#modaldelete{{$schedule->id}}"><i class="fas fa-trash-alt"></i></a>
                            </td>
                        </tr>
