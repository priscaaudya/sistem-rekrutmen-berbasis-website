...
@include('dashboard.schedule.create')
        ...
        <div style="float: right; margin-right:3%" >
            <a href="/schedules/create" class="btn btn-primary " data-toggle="modal" data-target="#modalcreate"><i class="fas fa-plus-circle"> Tambah Agenda</i></a>                
        </div>            
            ...
            <table class="table table-striped table-bordered zero-configuration" style="border: 1">
                ...
                <tbody>
                    ...
                    <tr align="center">
                        ...
                        <td>@if ($schedule->status == '1') Disetujui @elseif ($schedule->status == '0')  Ditolak @else Menunggu @endif</td>
                        <td>
                           <a href="/schedules/{{ $schedule->id }}/edit" class="btn btn-warning" data-toggle="modal" data-target="#modaledit{{$schedule->id}}"><i class="fas fa-edit"></i></a>
                           <a href="/schedules/{{ $schedule->id }}" class="btn btn-danger" data-toggle="modal" data-target="#modaldelete{{$schedule->id}}"><i class="fas fa-trash-alt"></i></a>      
                        </td>
                    </tr>
