            ...
            <tbody>
              @if($applicants->count())
                ...
                <tr align="center">
                    ...
                    <td>
                       @if ($applicant->status == '1') Memenuhi @else Tidak Memenuhi @endif
                       {{-- <input type="hidden" name="status" value="{{ $applicant->status }}"> --}}
                      </td>
                      <td>
                        <a href="/administration/{{ $applicant->id }}" class="btn btn-info" data-toggle="modal" data-target="#modalshow{{ $applicant->id }}"><i class="fas fa-eye"></i></a>
                        <a href="/administration/{{ $applicant->id }}/edit" class="btn btn-warning"  data-toggle="modal" data-target="#modaledit{{ $applicant->id }}"><i class="fas fa-edit"></i></a>
