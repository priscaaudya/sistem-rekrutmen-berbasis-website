                ...
                <table class="table table-striped table-bordered zero-configuration" style="border: 1">
                    ...
                    <tbody>
                        ...
                        <tr align="center">
                            ...
                            <td>@if ($sr->result == '1') Diterima @elseif ($sr->result == '0')  Ditolak @else Sedang Diproses @endif</td>
                            <td>{{ Carbon\Carbon::parse($sr->applicant->created_at)->format("d/m/Y") }}</td>
                            <td>
                                    <a href="/selectionresults/{{ $sr->id }}" class="btn btn-info" data-toggle="modal" data-target="#modalshow{{$sr->id}}"><i class="fas fa-eye"></i></a>
                                    ...
                                    <a href="/selectionresults/{{ $sr->id }}" class="btn btn-danger" data-toggle="modal" data-target="#modaldelete{{$sr->id}}"><i class="fas fa-trash-alt"></i></a>
                            </td>
                        </tr>
