        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="file" class="form-control @error('application_letter') is-invalid @enderror" required id="application_letter" name="application_letter">
                ...
                <div class="modal-body">
                    ...
                    <input type="file" class="form-control @error('cv') is-invalid @enderror" required id="cv" name="cv">
                    @error('cv')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="modal-body">
                    <label for="photo" class="form-label">Pas Foto (max 1 MB)</label>
                    <input type="file" class="form-control @error('photo') is-invalid @enderror" required id="photo" name="photo">
                    @error('photo')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="modal-body">
                    ...
                    <input type="file" class="form-control @error('certificate') is-invalid @enderror" required id="certificate" name="certificate">
                    @error('certificate')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="modal-body">
                    ...
                    <input type="file" class="form-control @error('transcript') is-invalid @enderror" required id="transcript" name="transcript">
                    @error('transcript')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="modal-body">
                    <label for="str" class="form-label">STR *jika ada (PDF max 5 MB)</label>
                    <input type="file" class="form-control @error('str') is-invalid @enderror" id="str" name="str">
                    @error('str')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
