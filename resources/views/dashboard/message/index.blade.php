            ...
            <table class="table table-striped table-bordered zero-configuration" style="border: 1">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <a href="/messages/{{ $message->id }}" class="btn btn-info" data-toggle="modal" data-target="#modalshow{{$message->id}}"><i class="fas fa-eye"></i></a>
                            <a href="/messages/{{ $message->id }}" class="btn btn-danger" data-toggle="modal" data-target="#modaldelete{{$message->id}}"><i class="fas fa-trash"></i></a>
                        </td>
                    </tr>
