    ...
    <div class="modal-dialog  modal-dialog-centered">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Selamat Anda Lolos Seleksi Tertulis!<br><br>
                    Agenda Tes Praktik akan dilaksanakan pada, <br>
                    Hari, tanggal : {{ Carbon\Carbon::parse($applicant->practicetest->schedule->date)->isoFormat('dddd, D MMMM Y') }} <br>
                    ...
                    <br><br>
                    Silahkan melakukan konfirmasi kehadiran maksimal satu hari sebelum tes praktik dilaksanakan, terima kasih.
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                    @if($applicant->practicetest->attendance == null)
                        <a href="/history/{{ $applicant->id }}/practiceconfirm" class="btn btn-primary" data-toggle="modal" data-target="#modalpracticeconfirm{{ $applicant->id }}">Konfirmasi Kehadiran</a>
                    @else
