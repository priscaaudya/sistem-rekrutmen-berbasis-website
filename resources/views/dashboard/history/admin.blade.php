    ...
    <div class="modal-dialog  modal-dialog-centered">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    Agenda Tes Tertulis akan dilaksanakan pada, <br>
                    Hari, tanggal : {{ Carbon\Carbon::parse($applicant->writtentest->schedule->date)->isoFormat('dddd, D MMMM Y') }} <br>
                    ...
                    <br><br>
                    Silahkan melakukan konfirmasi kehadiran dibawah ini maksimal satu hari sebelum tes tertulis dilaksanakan, terima kasih.
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                    @if($applicant->writtentest->attendance == null)
                    <a href="/history/{{ $applicant->id }}/writtenconfirm" class="btn btn-primary" data-toggle="modal" data-target="#modalwrittenconfirm{{ $applicant->id }}">Konfirmasi Kehadiran</a>
                    @else
