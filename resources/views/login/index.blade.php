                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                <a class="text-center" href="/"> <h4>RSU Ananda Purwokerto</h4></a>
                                ...
                                <p class="mt-5 login-form__footer">Belum memiliki akun? <a href="/register" class="text-primary">Daftar sekarang</a></p>
                            </div>
                        </div>
                    </div>
                </div>
